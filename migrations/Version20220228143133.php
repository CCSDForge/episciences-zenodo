 ...
 */
final class Version20220228143133 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE UNIQUE INDEX idx_log_unique ON log_user_action (username, doi_deposit_fix, doi_deposit_version)');
    }
